...
const UserDashboard = () => {
  ...
  const handleVideoComplete = () => {
    ...
    toast({
      ...
      description: "You've completed the awareness training. Start making a difference!",
    });
  };

  const menuItems = [
    { id: 'overview', label: 'Overview', icon: Recycle },
    { id: 'complaint', label: 'Report Issue', icon: Camera },
    { id: 'my-complaints', label: 'My Reports', icon: MessageSquare },
    { id: 'workers', label: 'Find Workers', icon: Users },
    { id: 'credits', label: 'My Credits', icon: Gift },
  ];
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground mt-2">
          Track your environmental impact and manage waste reports
        </p>
      </div>
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-2xl font-bold text-eco-green">
                  {user?.credits && user.credits >= 100 ? 'Champion' : 
                   user?.credits && user.credits >= 50 ? 'Hero' : 'Beginner'}
                </p>
              </div>
            </div>
          </CardContent>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            >
              <CardContent className="p-6 text-center">
                ...
                <p className="text-sm text-muted-foreground">
                  Take a photo and report waste management problems in your area
                </p>
              </CardContent>
            </Card>
            ...
            >
              <CardContent className="p-6 text-center">
                ...
                <p className="text-sm text-muted-foreground">
                  Connect with local waste collectors and compare prices
                </p>
              </CardContent>
            </Card>
          </div>
      ...
      <Card className="eco-shadow eco-gradient-subtle border-eco-green">
        <CardContent className="p-6">
          <div className="flex items-start gap-4">
            ...
            <div>
              <h3 className="font-semibold text-eco-dark mb-2">💡 Eco Tip of the Day</h3>
              <p className="text-sm text-eco-dark/80">
                ...
                Start segregating your waste today and earn credits while helping the environment.
              </p>
            </div>
          </div>
        </CardContent>
